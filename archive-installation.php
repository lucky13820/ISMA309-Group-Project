...
$terms = get_terms( 'installationcat' );
if ( ! empty( $terms ) && ! is_wp_error( $terms ) ){
    echo '<ul id ="cat_nav" class="cat_nav">';
		echo '<li><a href="' . esc_attr(get_post_type_archive_link( 'installation' )) . '">'. All .'</a></li>';
                ...
                <?php if (have_posts()) :
                    ...
                    while(have_posts()) : the_post();
                        ...
                        <?php
                             ...
                             */
                            get_template_part( 'template-parts/content-box-installation', get_post_format() );
                        ?>
                        <?php $i++;
